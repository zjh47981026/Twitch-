...
@Configuration
@EnableWebMvc // create some objects for spring MVC to operate
public class ApplicationConfig {
    ...
    public DataSource dataSource() {
        String RDS_ENDPOINT = "twitch.cliimavgnpdk.us-east-2.rds.amazonaws.com";
        String USERNAME = "admin";
        String PASSWORD = "zhangjiahao";
